...
#### Variables ############################################
trnd <- 0.9 # Can be 1, 0.98, 0.95, or 0.9
trnd.psi <- 0.9525030 # 0.9525030, 0.9854334, 0.9963604, or 1 when trnd = 0.9, 0.95, 0.98, or 1, respectively
                      # (averaged across 30 simulations for each trend scenario)
sims <- 300 #Set to number of simulated analyses desired per scenario.
